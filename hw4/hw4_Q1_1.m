...
%% Initualize xygrid by linear interpolation
...
for i = 1:IL
        y_temp = linspace(ygrid(1,i),yend,JL);
        ygrid(:,i)=y_temp;
end
...
xlabel('x');
ylabel('y');
title('no grid stretching, airfoil','FontSize',20);
saveas(gcf,'linear_airfoil','epsc')
